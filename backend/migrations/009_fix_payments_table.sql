...
ALTER TABLE payments ADD COLUMN IF NOT EXISTS payment_details JSONB DEFAULT '{}';
ALTER TABLE payments ADD COLUMN IF NOT EXISTS fraud_score DECIMAL(5,2);
...
ALTER TABLE refunds ADD COLUMN IF NOT EXISTS refund_transaction_id VARCHAR(255);
